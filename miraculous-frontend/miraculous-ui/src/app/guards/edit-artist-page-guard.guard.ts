...
export class EditArtistPageGuardGuard implements CanActivate {
  ...
  canActivate(next: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<boolean | UrlTree> | Promise<boolean | UrlTree> | boolean | UrlTree {
    ...
    if (this.tokenService.getToken(this.tokenService.isRememberMeModeOn()) != null
      && this.tokenService.getRole(this.tokenService.isRememberMeModeOn()) == "artist" && next.params["id"]== this.tokenService
        .getVisitorId(this.tokenService.isRememberMeModeOn())){
